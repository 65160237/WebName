...
{{-- <div class="main-menu-content ps">
        <ul layout="vertical" core-menu="" class="navigation navigation-main">
            <li core-menu-vertical-item="" tabindex="0" class="ng-star-inserted">
                <a class="d-flex align-items-center ng-star-inserted" target="_self" href="/regisweb/home">
                    <!-- เพิ่มข้อความเพื่ออธิบายลิงก์ -->
                    <span class="menu-title">หน้าแรก</span>
                </a>
            </li>
            <!-- รายการลิงก์อื่น ๆ -->
            <li core-menu-vertical-item="" tabindex="0" class="ng-star-inserted">
                <a class="d-flex align-items-center ng-star-inserted" target="_self" href="/regisweb/login">
                    <span class="menu-title">เข้าสู่ระบบ</span>
                </a>
            </li>
            <!-- รายการลิงก์อื่น ๆ -->
            <li core-menu-vertical-item="" tabindex="0" class="ng-star-inserted">
                <a class="d-flex align-items-center ng-star-inserted" target="_self" href="/regisweb/classinfo">
                    <span class="menu-title">วิชาที่เปิดสอน</span>
                </a>
            </li>
            <!-- รายการลิงก์อื่น ๆ -->
            <li core-menu-vertical-item="" tabindex="0" class="ng-star-inserted active">
                <a class="d-flex align-items-center ng-star-inserted" target="_self" href="/regisweb/calendar">
                    <span class="menu-title">ปฎิทินการศึกษา</span>
                </a>
            </li>
            <!-- รายการลิงก์อื่น ๆ -->
            <li core-menu-vertical-item="" tabindex="0" class="ng-star-inserted">
                <a class="d-flex align-items-center ng-star-inserted" target="_self" href="/regisweb/programinfo">
                    <span class="menu-title">หลักสูตรที่เปิดสอน</span>
                </a>
            </li>
            <!-- รายการลิงก์ย่อย -->
            <li core-menu-vertical-collapsible="" class="nav-item has-sub ng-star-inserted">
                <a class="d-flex align-items-center ng-star-inserted">
                    <span class="menu-title text-truncate ng-star-inserted">รายงานสถิติเผยแพร่</span>
                </a>
                <ul class="menu-content ng-star-inserted">
                    <!-- รายการลิงก์ย่อย -->
                    <li core-menu-vertical-item="" tabindex="0" class="ng-star-inserted">
                        <a class="d-flex align-items-center ng-star-inserted" target="_self"
                            href="/regisweb/execstudentcurrentbysex">
                            <span class="menu-title">จำนวนนักศึกษาปัจจุบัน</span>
                        </a>
                    </li>
                    <!-- รายการลิงก์ย่อย -->
                    <li core-menu-vertical-item="" tabindex="0" class="ng-star-inserted">
                        <a class="d-flex align-items-center ng-star-inserted" target="_self"
                            href="/regisweb/revenrollhome">
                            <span class="menu-title">จำนวนนักศึกษาลงทะเบียน</span>
                        </a>
                    </li>
                </ul>
            </li>
